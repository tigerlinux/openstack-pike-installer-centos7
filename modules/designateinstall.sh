...
su -s /bin/sh -c "designate-manage pool update --file /etc/designate/pools.yaml" designate

cat ./libs/designate/tlds-alpha-by-domain.txt > /etc/designate/tlds-alpha-by-domain.txt

chown designate.designate /etc/designate/tlds-alpha-by-domain.txt

# designate-manage tlds import --input_file /etc/designate/tlds-alpha-by-domain.txt
su -s /bin/sh -c "designate-manage tlds import --input_file /etc/designate/tlds-alpha-by-domain.txt" designate
...
chown designate.designate $dnsextratldfile

# designate-manage tlds import --input_file $dnsextratldfile
su -s /bin/sh -c "designate-manage tlds import --input_file $dnsextratldfile" designate
